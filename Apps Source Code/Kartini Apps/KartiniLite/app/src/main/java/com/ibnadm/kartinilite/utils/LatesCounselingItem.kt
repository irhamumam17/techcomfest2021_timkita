...
class LatestCounselingItem(val message:Message): Item<ViewHolder>(){
    var chatPartnerUser: Counselor? = null
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        val ref = FirebaseDatabase.getInstance().reference.child("counselors/$chatPartnerUid")
        ref.addListenerForSingleValueEvent(object: ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                chatPartnerUser = p0.getValue(Counselor::class.java)
